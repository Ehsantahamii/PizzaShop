  ...
  return (
    <>
      <nav className="shadow-md p-2 bg-white fixed w-full h-16 z-50 Lalezar">
        <div className="navbar container  flex justify-between h-full items-center ">
          <div className="icons flex ">
            <span
              className="bg-slate-100 p-2 rounded-full cursor-pointer ml-1"
            ...
            <span
              className={` ${
                makeVisible
                  ? "bg-slate-100 p-2 rounded-full cursor-pointer hidden rotate-icon"
                  : "bg-slate-100 p-2 rounded-full cursor-pointer hidden"
              }`}
          ...
          <div className="nav-items w-2/4">
            <ul className="flex justify-around ">
              <Link
                ...
                duration={500}
              >
                <li className="p-2 rounded-md cursor-pointer hover:bg-green-700 hover:text-white">
                  <a href="#">خانه</a>
                </li>
              </Link>
      ...
      <div
        className={` ${
          makeVisible
            ? " dropdown-menu fixed z-40  shadow-sm nav-showing  "
      ...
      <div
        className={` ${
          openBox
            ? "search-box fixed w-full h-full bg-gray-500 bg-opacity-90 animate-[pulses_0.3s_ease] z-50"
            : "search-box absolute w-full h-full bg-gray-500 bg-opacity-70 animate-[pulses_0.3s_ease] z-50 hidden"
        }`}
      >
        <BsXLg
          className=" absolute w-6 h-6 top-3 right-5 text-white cursor-pointer"
          onClick={() => setOpenBox(!openBox)}
        />
        <article className="absolute top-1/3 left-2/4 ">
          <label className="relative" htmlFor="">
            ...
            <input
              autoComplete="on"
              className="w-96 bg-transparent border-b-2 text-white placeholder:text-white p-1"
              type="search"
              name="searchbox"
              id="src"
